...
//Creating variable to store node request package link
var request = require("request");

//Creating variable to store node file system link
var fs = require("fs");
...
//Creating variable to store data input for third node command line argument
var command = process.argv[2];

//Creating blank variable to hold search term
var searchTerm = "";

//Assigning variable to process.argv array
var searchArray = process.argv;

//Initial invokation of verify command function
verifyCommand();
